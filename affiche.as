...
Affiche:	save	%sp,-96,%sp		!sauvegarde l'environnement de l'appelant
...
aff00:		ldub	[%i0+%l0],%o1		!Lecture de la case courante
		add	%o1,'0',%o1		!Transformation en caractere
		cmp	%o1,'0'			!Verifie si le resultat est '0'
		bne	aff10			!Different de '0', traitement normal
		nop				!...
		
		mov	' ',%o1			!Caractere d'espace si c'est 0
		
aff10:		set	prntnum,%o0		!Format qui affiche un caractere, le nombre
...
aff15:		cmp	%l1,8			!verifie si on aura un multiple de 9
...
aff20:		cmp	%l0,80			!A-t-on affiche la derniere case?
...
aff30:		inc	%l0			!avance a la case suivante
