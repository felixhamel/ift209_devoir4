...
Verif00:	ldub	[%i0+%l0],%l7		!lecture de la case courante	
...
Verif03:	set 	ptfmt2,%o0		!message d'erreur
		set	redir,%o1		!sous-chaine: type de zone
		...
		*/		
Verif05:	cmp	%l0,80			!A-t-on termine le parcours?
...
Verif07:	mov	0,%l0			!recommence le parcours a la case 0
...
Verif10:	call	printf			!affiche le message
		nop				!...
...
ptfmt2:		.asciz "Le sudoku contient une erreur dans %s %d\n"
